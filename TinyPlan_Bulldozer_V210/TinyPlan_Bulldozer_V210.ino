...
// Version
String FW_Version = "TinyPlan Bulldozer v2.10 (2017/5/14)";
...
void handleIndex()
{
  ...
  content += "<table>";
  content += "<tr>";
  content += "<td><button  class=\"pm_btn\" style=\"background: #ff9900;\" type=\"button\" onclick=\"controlPm(6)\">MaxUP</button></td>";
  content += "<td><button  class=\"pm_btn\" type=\"button\" onclick=\"controlPm(4)\">FORWARD</button></td>";
  content += "<td><button  class=\"pm_btn\" style=\"background: #ffcc00;\" type=\"button\" onclick=\"controlPm(5)\">UP</button></td>";
  content += "</tr>";

  content += "<tr>";
  content += "<td><button  class=\"pm_btn\" type=\"button\" onclick=\"controlPm(2)\">LEFT</button></td>";
  content += "<td><button  class=\"pm_btn\" style=\"background: #ed3db5;\" type=\"button\" onclick=\"controlPm(9)\">STOP</button></td>";
  content += "<td><button  class=\"pm_btn\" type=\"button\" onclick=\"controlPm(1)\">RIGHT</button></td>";
  content += "</tr>";

  content += "<tr>";
  content += "<td><button  class=\"pm_btn\" style=\"background: #ff9900;\" type=\"button\" onclick=\"controlPm(8)\">MaxDOWN</button></td>";
  content += "<td><button  class=\"pm_btn\" type=\"button\" onclick=\"controlPm(3)\">BACK</button></td>";
  content += "<td><button  class=\"pm_btn\" style=\"background: #ffcc00;\" type=\"button\" onclick=\"controlPm(7)\">DOWN</button></td>";
  content += "</tr>";
  content += "</table>";
...
void loop(void) {
  ...
  if (Servo_PROGRAM >= 1 )
  {
    ...
    {
      case 1:  // 右轉動作 1
        Set_PWM_to_Servo(0,110);
        Set_PWM_to_Servo(1,110);
        break;
      case 2:  // 左轉動作 2
        Set_PWM_to_Servo(0,70);
        Set_PWM_to_Servo(1,70);
        break;
      case 3:  // 後退動作 3
        Set_PWM_to_Servo(0,110);
        Set_PWM_to_Servo(1,70);
      ...
      case 4:  // 前進動作 4
        ...
        break;
      case 5:  // 上升動作 5
        if(Bucket_Angle >= 70){Bucket_Angle = Bucket_Angle - 10;}
        Set_PWM_to_Servo(2,Bucket_Angle);
        break;
      case 6:  // 最大上升動作 6
        Bucket_Angle = 60;
        Set_PWM_to_Servo(2,60);
        break;
      case 7:  // 下降動作 7
        if(Bucket_Angle <= 140){Bucket_Angle = Bucket_Angle + 10;}
        Set_PWM_to_Servo(2,Bucket_Angle);
        break;
      case 8:  // 最大下降動作 8
        Bucket_Angle = 150;
        Set_PWM_to_Servo(2,150);
        break;
      case 9:  // 停止動作 9
        Set_PWM_to_Servo(0,90);
        Set_PWM_to_Servo(1,90);
        break;
      case 99: // 待機
        Bucket_Angle = 90;
